...
const HeroSection = () => {
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-20 left-10 w-40 h-40 border border-secondary/10 rounded-full opacity-15 animate-[spin_45s_linear_infinite_reverse]" />
      <div className="absolute top-1/3 left-1/4 w-2 h-2 bg-accent/40 rounded-full" />
      <div className="absolute top-2/3 right-1/3 w-1.5 h-1.5 bg-secondary/40 rounded-full" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-foreground leading-tight mb-6">
          ...
          <br />
          <span className="text-accent">Built on Precision.</span>
        </h1>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <a href="#contact">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold text-lg px-8 py-6 glow-orange">
              Get a Quote <ArrowRight className="ml-2 w-5 h-5" />
            </Button>
          </a>
          <a href="#projects">
            <Button size="lg" variant="outline" className="border-border text-foreground hover:bg-card font-semibold text-lg px-8 py-6">

...
const AboutSection = () => {
  ...
  const cards = [
    ...
    { icon: Lightbulb, titleKey: "about_card2_title" as const, textKey: "about_card2_text" as const },
    { icon: Shield, titleKey: "about_card3_title" as const, textKey: "about_card3_text" as const },
  ];
